                                ...
                                <tbody>
                                    {
                                        products && products.map((product,index) =>(
                                            ...
                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                              <Link to={`/dashboard/update-product/${product._id}`} className="bg-blue-500 text-white px-3 py-1 rounded-xl">Cập nhật</Link>
                                            </td>
                                            <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                                              <button
                                              onClick={() => handleDeleteProduct(product._id)}
                                              className='bg-red-600 text-white px-3 py-1 rounded-xl'>Xoá</button>
                                            </td>
                                        </tr>
                                        ))
                                    }
