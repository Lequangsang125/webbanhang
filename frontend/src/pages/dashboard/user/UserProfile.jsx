...
const UserProfile = () => {
    ...
    const handleChange = async (e) => {
     ...
     const handleSubmit = async (e) => {
        ...
        try {
           const res = await editProfile(updatedUser).unwrap();
           console.log(res);
                    ...
                    <div className='fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50'>
                        <div className='bg-white p-6 rounded-lg md:w-96 max-w-xl mx-auto relative'>
                            <button
                                ...
                                className='absolute top-2 right-2 text-gray-500 hover:text-gray-500'><i className='ri-close-line size-8 p-2 bg-black rounded-full'></i></button>
                            ...
                            <form onSubmit={handleSubmit} >
                                ...
                                <div className='mb-4'>
                                    <label htmlFor="profileImage" className='block text-sm font-medium text-gray-700 mb-1'>ProfileImage:</label>
                                ...
                                {isError && <p className='mt-2 text-red-500'>Lỗi, vui lòng thử lại</p>}
                                {isSuccess && <p className='mt-2 text-green-500'>Cập nhật thành công</p>}
                            </form>
                        </div>
                    </div>
                )
